...
return array(
    ...
    'FILTER_FUNCTION'               => array('htmlspecialchars','strip_tags'), //过滤函数会在input(),date_format()等函数中使用
    /********************************数据库********************************/
    ...
    'TPL_PATH'                      => 'Tpl',      //模板目录
    'TPL_STYLE'                     => '',          //风格
    'TPL_FIX'                       => '.phtml',     //模版文件扩展名
    'TPL_TAGS'                      => array(),     //模板标签
    'TPL_ERROR'                     => 'error',     //错误信息模板
    'TPL_SUCCESS'                   => 'success',   //正确信息模板
    'TPL_ENGINE'                    => 'JFIT',        //模板引擎 JFIT,Smarty
    'TPL_TAG_LEFT'                  => '<',         //左标签
    'TPL_TAG_RIGHT'                 => '>',         //右标签
    ...
    'URL_ROUTE_ON'                  => FALSE,       //url重写模式
    'URL_TYPE'                      => 1,           //类型 1:PATHINFO模式 2:普通模式 3:兼容模式
    'PATHINFO_DLI'                  => '/',         //URL分隔符 URL_TYPE为1、3时起效
    'PATHINFO_VAR'                  => 'q',         //兼容模式get变量
    'HTML_SUFFIX'                   => '',          //伪静态扩展名
    'VAR_GROUP'                     => '__g__',         //模块组URL变量
    'VAR_MODULE'                    => '__m__',         //模块URL变量
    'VAR_CONTROLLER'                => '__c__',         //控制器URL变量
    'VAR_ACTION'                    => '__a__',         //动作URL变量
    'DENY_MODULE'                   => array('Common','Addons'),//禁止使用的模块
    ...
    /********************************验证码********************************/
    'CODE_FONT'                     => JFUNIT_PATH . 'Data/Font/font.ttf', //字体
